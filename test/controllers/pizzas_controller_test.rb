...
class PizzasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pizza" do
    assert_difference('Pizza.count') do
      post pizzas_url, params: { pizza: { name: @pizza.name, price: @pizza.price, source: @pizza.source } }
    end
  ...
  test "should update pizza" do
    patch pizza_url(@pizza), params: { pizza: { name: @pizza.name, price: @pizza.price, source: @pizza.source } }
